...
try {
    ...
    console.log("🌍 Connected to the DARKSHAN  DB")
} catch {
...
`.trim());
                ...
                console.log(e)
             //   await Void.sendMessage('94772108460@s.whatsapp.net',{text: util.format(mek)})
               // await Void.sendMessage('94772108460@s.whatsapp.net',{text: util.format(e)})
            }
        })
 const { sck } = require('.')
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("✅ dark shan Login Successful!");
                    ...
                    console.log("⬇️ External Plugins Installed!");fs.readdirSync(__dirname + "/../commands").forEach((plugin) => {
