...
global.github = 'https://github.com/kushansewmina1234/DARK-SHAN-MD-0.0.1V'
global.location = 'colombo LK'
global.gurl = 'https://instagram.com/' // add your username
global.sudo = process.env.SUDO || '94772108460'
global.devs = '94772108460';
global.website = 'https://github.com/kushansewmina1234/DARK-SHAN-MD-0.0.1V' //wa.me/+25000000000000
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'kushan' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'DARK SHAN MD' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'darkshan-md' : process.env.PACK_INFO.split(";")[1],
